...
/**
 * Reusable icon component supporting all 14 provided SVG assets.
 * Fills/strokes are mapped to `currentColor` so they inherit color classes from Tailwind.
 * @param {object} props
 * @param {string} props.name - The name of the icon (e.g. 'cog-8-tooth', 'arrow-path', etc.)
 * @param {string} [props.className] - Tailwind classes for dimensions and text color (default: 'w-6 h-6')
 * @returns {React.ReactElement|null} The SVG element
 */
